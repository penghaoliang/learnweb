...
<embed width="480" height="360" border="0" showdisplay="0" showcontrols="1" autostart="1" autorewind="0" playcount="0" moviewindowheight="1024" moviewindowwidth="728" filename="/web/WebContent/course_content/1.5.2.mp4" src="1.5.2.mp4">
</embed>
