...
<body>
	...
	<div id="login">
		<form name="form2" method="post" action="" id="form2">
			...
			<div id="loginContent"
				style="background-color: #FFFEF9; margin: 0px;">
				<ul id="loginUl">
					<li>用户名：<input type="text" name="username" id="username"
						style="width: 120px">
					</li>
					<li>密&nbsp;码：<input type="password" name="pwd" id="pwd"
						style="width: 120px">&nbsp;
					</li>
					<li style="padding-left: 40px;"><input name="Submit"
						type="submit" value="登录"> &nbsp; <input name="Submit2"
						type="button" value="关闭" onClick="myClose(login)"></li>
				</ul>
			</div>
