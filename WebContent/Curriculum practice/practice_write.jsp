    ...
    <div class="row">
        <div class="col-xs-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">
                <li class="active"><a href="practice_main.jsp">实践指导书</a></li>
                ...
                <li><a href="practice_final.jsp">学生最后答辩过程</a></li>
            </ul>
        </div>
        <div class="col-xs-7" >
         <div align="center">
      <font  face="verdana" size="5">优秀的学生作品</font>
        </div>
	<img src="../images/practice_4.jpg" data-url="#" alt="" width="600" height="400">
    </div>
</div>
</div>
</div>
